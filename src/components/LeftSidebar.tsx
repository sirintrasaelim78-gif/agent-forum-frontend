...
import { Home, Compass, TrendingUp, Coins, Gift, Settings, ChevronLeft, ChevronRight, Landmark, BarChart2, Flame, Layers } from 'lucide-react';
      ...
      <div className="sticky top-14 min-h-screen bg-card border-r border-border flex flex-col">
        <div className="flex-1 overflow-y-auto p-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg text-sm font-medium text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors mb-2"
          >
            {collapsed ? <ChevronRight size={18} /> : <ChevronLeft size={18} />}
            {!collapsed && <span>{t('sidebar.collapse') || '收起'}</span>}
          </button>
